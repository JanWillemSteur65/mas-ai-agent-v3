          ...
          <div className="mx-login__shell">
            <aside className="mx-login__brand" aria-hidden="true">
              <div className="mx-login__brandInner">
                ...
                <div className="mx-login__footerNote">
                  {authInfo?.mode === 'remote'
                    ? <>Authentication via MCP Server • Users stored centrally</>
                    : <>Local authentication • Users stored in <code>/data/users.json</code></>
                  }  
                </div>
              </div>
            </aside>
